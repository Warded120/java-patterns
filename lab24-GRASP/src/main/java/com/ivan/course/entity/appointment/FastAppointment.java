...
public class FastAppointment extends Appointment {
    public FastAppointment(Patient patient, Doctor doctor, LocalDate appointmentDate) {
        super(patient, doctor, appointmentDate);
    }

    @Override
    public boolean handle() {
        double probability = (double)doctor.getExperience()/100 + .3 + ((36.6 - patient.getTemperature()) / 10);
